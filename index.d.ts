 ...
 */
export declare type Timer = TimerState & TimerApi;
/**
 * Timer state values.
 */
...
export declare type TimerApiSubscribe = (cb: TimerSubscriber) => () => void;
export declare type TimerSubscriber = (timer: Timer, event: TimerEvent) => void;
/**
 * An object passed as the second argument to a subscriber callback.
 */
export declare type TimerEvent = 
